...
# prepare object points, here 5x5 board dimensionstranslates to 4x4
...
with open('/Users/hannahlangart/Desktop/ComputerVision/images_used.txt', 'w') as outfile:
    ...
    for fname in images: # loop through all the jpg images loaded
        ...
        if ret == True:
            ...
            filename = "/Users/hannahlangart/Desktop/ComputerVision/calibration_%d.jpg"%d # save calibration image with counter as identifier
...
with open('/Users/hannahlangart/Desktop/ComputerVision/camera_parameters.txt', 'w') as outfile:
