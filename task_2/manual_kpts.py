...
# load images
im1 = cv2.imread('HG_02.jpg')
im2 = cv2.imread('HG_03.jpg')
...
mplcursors.cursor()
fig.suptitle("Select keypoint location")
plt.show()'''
...
axes2[0].scatter(x=A_x, y=A_y, c='lime',s=0.5)
...
match_img=cv2.imread('manual_both.eps')
cv2.line(match_img,(0,0),(511,511),(255,0,0),5)
