# Adapted from: https://www.geeksforgeeks.org/python-opencv-epipolar-geometry/
import numpy as np 
import cv2 
...
img1_name = 'HG_04.jpg'
img2_name = 'HG_05.jpg'
img1 = cv2.imread(img1_name, 0) # 0 stands fro gray scale
...
with open('fundamental_matrix.txt', 'w') as outfile:
