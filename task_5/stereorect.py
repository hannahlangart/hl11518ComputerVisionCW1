...
img1_name = 'IMG-3560.jpg'
img2_name = 'IMG-3544.jpg'
...
#R = []  # set to rotation vector for corresponding image
#R = np.array(R)
#
## translation vectors (extrinsic parameters) 
#T = [] # set to translation vector for corresponding image
#T = np.array(T)
#
